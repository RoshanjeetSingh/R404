  ...
  return (
    <div>
      <fieldset className="mt-8 mb-2">
        <legend>
          <div className="flex items-center bg-white px-1.5 py-1 rounded">
          <FaPeoplePulling className="text-xl" />
          <h1 className="inline text-[#333]  border-none  rounded shadow-[3px_3px_5px_0_rgba(0,0,0,0.15)] font-bold text-xl flex items-center gap-2">
             ABOUT PEOPLE
          </h1>
          </div>
        </legend>
